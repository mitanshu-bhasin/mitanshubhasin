...
<head>
    ...
    <!-- --- SEO OPTIMIZATION (GOD MODE v4.0) --- -->
    <title>Mitanshu Bhasin | System Architect & Full Stack Developer</title>
    <meta name="description" content="Official Portfolio of Mitanshu Bhasin, a 16-year-old System Architect, Ethical Hacker, and JEE Aspirant. Expert in React, Firebase, Python, and Secure Infrastructure. Based in Delhi.">
    <meta name="keywords" content="Mitanshu Bhasin, Web Developer Delhi, System Architect, Full Stack Developer, React JS, Firebase, Ethical Hacking, JEE Aspirant, Python Developer, Cyber Security Expert">
    <meta name="author" content="Mitanshu Bhasin">
    <meta name="robots" content="index, follow, max-image-preview:large">
    <meta name="googlebot" content="index, follow">
    <link rel="canonical" href="https://mitanshubhasin.netlify.app/">
    <link rel="manifest" href="manifest.json">
    
    <!-- Open Graph / Facebook / LinkedIn -->
    <meta property="og:type" content="profile">
    <meta property="og:url" content="https://mitanshubhasin.netlify.app/">
    <meta property="og:title" content="Mitanshu Bhasin | System Architect">
    <meta property="og:description" content="Building digital empires at 16. Expert in React, Node.js, and Security Architecture. 70+ Certifications including MeitY & freeCodeCamp.">
    <meta property="og:image" content="https://mitanshubhasin.netlify.app/og-image.jpg">
    <meta property="og:site_name" content="Mitanshu Bhasin Portfolio">

    <!-- Twitter -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:url" content="https://mitanshubhasin.netlify.app/">
    <meta name="twitter:title" content="Mitanshu Bhasin | System Architect">
    <meta name="twitter:description" content="Building digital empires at 16. Expert in React, Node.js, and Security Architecture.">
    <meta name="twitter:image" content="https://mitanshubhasin.netlify.app/og-image.jpg">
    ...
    <script type="application/ld+json">
    {
      ...
      "url": "https://mitanshubhasin.netlify.app",
      "jobTitle": "System Architect",
      "image": "https://mitanshubhasin.netlify.app/og-image.jpg",
      "address": {
        "@type": "PostalAddress",
      ...
      "sameAs": [
        "https://instagram.com/mitanshubhasin",
        "https://github.com/mitanshu-bhasin",
        "https://linkedin.com/in/mitanshubhasin",
        "https://facebook.com/mitanshubhasin",
        "https://www.threads.net/@mitanshubhasin",
        "https://www.instagram.com/cyber.mitanshu/",
        "https://linktr.ee/mitanshubhasin",
        "https://cyberserpent.netlify.app/",
        "https://mb-study.netlify.app/",
        "https://dev.to/t/mitanshubhasin"
      ],
      "knowsAbout": ["React", "Firebase", "System Architecture", "Python", "Ethical Hacking", "Linux Server Management"]
    }
    </script>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;800&family=Fira+Code:wght@300;400;600&family=Orbitron:wght@400;700;900&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        .theme-light .glass-panel { background: rgba(255, 255, 255, 0.7); backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.9); box-shadow: 0 4px 30px rgba(0,0,0,0.05); }

        /* --- THEME: CYBER (HACKER MODE) --- */
        body.theme-cyber {
            background-color: #0f172a;
            color: #f8fafc;
            font-family: 'Fira Code', monospace;
        }
        .theme-cyber .font-heading { font-family: 'Orbitron', sans-serif; }
        .theme-cyber .glass-panel { background: rgba(0, 0, 0, 0.7); backdrop-filter: blur(8px); border: 1px solid rgba(59, 130, 246, 0.3); box-shadow: 0 0 15px rgba(59, 130, 246, 0.1); }
        ...
        .skill-bar-fill { width: 0; transition: width 1.5s cubic-bezier(0.2, 0.8, 0.2, 1); }
        .reveal.active .skill-bar-fill { width: var(--target-width); }

        .tilt-card { transition: transform 0.1s; transform-style: preserve-3d; }
        
        /* Modal Animation */
        @keyframes zoomIn { from { transform: scale(0.9); opacity: 0; } to { transform: scale(1); opacity: 1; } }
        .animate-zoom { animation: zoomIn 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.28) forwards; }
        ...
        body.theme-light .scroll-progress-bar { background: linear-gradient(90deg, #2563eb, #7c3aed); }
        body.theme-cyber .scroll-progress-bar { background: #3b82f6; box-shadow: 0 0 10px #3b82f6; }

        .scanlines {
            position: fixed; top: 0; left: 0; width: 100vw; height: 100vh;
            background: linear-gradient(to bottom, rgba(255,255,255,0), rgba(255,255,255,0) 50%, rgba(0,0,0,0.2) 50%, rgba(0,0,0,0.2));
            background-size: 100% 4px; z-index: 90; pointer-events: none; opacity: 0; transition: opacity 0.3s;
        }
        body.theme-cyber .scanlines { opacity: 0.6; }
        ...
        .glitch-text::before { left: 2px; text-shadow: -1px 0 red; clip-path: inset(0 0 0 0); animation: glitch-anim-1 2s infinite linear alternate-reverse; display: none;}
        .glitch-text::after { left: -2px; text-shadow: -1px 0 blue; clip-path: inset(0 0 0 0); animation: glitch-anim-2 3s infinite linear alternate-reverse; display: none;}
        body.theme-cyber .glitch-text::before, body.theme-cyber .glitch-text::after { display: block; }
        ...
        @keyframes glitch-anim-2 { 0% { clip-path: inset(10% 0 60% 0); } 20% { clip-path: inset(30% 0 20% 0); } 40% { clip-path: inset(70% 0 10% 0); } 60% { clip-path: inset(20% 0 50% 0); } 80% { clip-path: inset(60% 0 20% 0); } 100% { clip-path: inset(40% 0 30% 0); } }

        /* Scrollbar */
        ::-webkit-scrollbar { width: 8px; }
        body.theme-light ::-webkit-scrollbar-track { background: #f1f5f9; }
        body.theme-light ::-webkit-scrollbar-thumb { background: #94a3b8; border-radius: 4px; }
        body.theme-cyber ::-webkit-scrollbar-track { background: #0a0a0a; }
        body.theme-cyber ::-webkit-scrollbar-thumb { background: #3b82f6; border: 1px solid #1e293b; }
        
        #preloader { position: fixed; inset: 0; z-index: 9999; background: #000; display: flex; align-items: center; justify-content: center; font-family: 'Fira Code', monospace; color: #f8fafc; flex-direction: column; }
    </style>
</head>
...
<script async id="netlify-rum-container" src="/.netlify/scripts/rum" data-netlify-rum-site-id="65cba0b0-a094-450c-bedd-61028e1b6e82" data-netlify-deploy-branch="" data-netlify-deploy-context="production" data-netlify-cwv-token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzaXRlX2lkIjoiNjVjYmEwYjAtYTA5NC00NTBjLWJlZGQtNjEwMjhlMWI2ZTgyIiwiYWNjb3VudF9pZCI6IjY5MWVlMTE5ZDQ2NzU3NDA1YTMxNWE2OCIsImRlcGxveV9pZCI6IjY5OGYzZThjNjZhZWUwMWYxZTQ2MDIzNyIsImlzc3VlciI6Im5mc2VydmVyIn0.ObEN6JR_oY-hKV-JZLrooQTzoEGZTmyULkE1CyvY50Y"></script></body>
</html>